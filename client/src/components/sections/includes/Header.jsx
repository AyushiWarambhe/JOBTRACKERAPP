...
const Header = () => {
    ...
    // if user is null, create a fallback object to avoid crashes
    const isLoggedIn = user?.logedIn || false;
                    ...
                    <div className='search-bar grow'>
                        <form className="max-w-md mx-auto">
                            <div className="relative">
                                ...
                                <button
                                    type="submit"
                                    className="text-white absolute end-0 top-1/2 -translate-y-1/2 
